...
- **RuboCop** with `rubocop-rspec` and `rubocop-performance` extensions — run `bundle exec rubocop` before committing
...
Open a [GitHub issue](https://github.com/svyatov/http_wrapper/issues) for questions or discussion.
